...
-- 스토어 더미 데이터
INSERT IGNORE INTO store (name, location, store_code, require_approval, business_number, default_hourly_wage, created_at) VALUE
    ('맥도날드 강남점', '서울 강남구', 'STORE001', false, '123-45-67890', 10030, NOW()),
    ('스타벅스 홍대점', '서울 마포구', 'STORE002', false, '234-56-78901', 10030, NOW()),
    ('롯데리아 가좌점', '인천 서구', 'STORE003', false, '222-56-78901', 10030, NOW()),
    ('KFC 부평점', '인천 부평구', 'STORE004', false, '222-56-73201', 10030, NOW()),
    ('버거킹 구월점', '인천 남동구', 'STORE005', false, '322-56-78901', 10030, NOW());
...
) SELECT 1, 3, '2024-02-27', '09:00:00', '18:00:00', '01:00:00', 'MON,WED,FRI', '2024-12-31'
WHERE NOT EXISTS (SELECT 1 FROM schedule WHERE store_id = 1 AND user_id = 3 AND work_date = '2024-02-27')
UNION
SELECT 1, 4, '2024-02-27', '10:00:00', '19:00:00', '01:00:00', 'TUE,THU,SAT', '2024-12-31'
WHERE NOT EXISTS (SELECT 1 FROM schedule WHERE store_id = 1 AND user_id = 4 AND work_date = '2024-02-27')
UNION
SELECT 1, 5, '2024-02-27', '11:00:00', '20:00:00', '01:00:00', 'MON,WED,FRI', '2024-12-31'
...
INSERT IGNORE INTO schedule (
    store_id, user_id, work_date, start_time, end_time,
    break_time, repeat_days, repeat_end_date
) SELECT 2, 6, '2024-02-27', '09:00:00', '18:00:00', '01:00:00', 'TUE,THU,SAT', '2024-12-31'
WHERE NOT EXISTS (SELECT 1 FROM schedule WHERE store_id = 2 AND user_id = 6 AND work_date = '2024-02-27')
UNION
SELECT 2, 7, '2024-02-27', '10:00:00', '19:00:00', '01:00:00', 'MON,WED,FRI', '2024-12-31'
...
INSERT IGNORE INTO schedule (
    store_id, user_id, work_date, start_time, end_time,
    break_time, repeat_days, repeat_end_date
) SELECT 3, 3, '2024-03-01', '08:00:00', '17:00:00', '01:00:00', 'MON,WED,FRI', '2024-12-31'
...
INSERT IGNORE INTO schedule (
    store_id, user_id, work_date, start_time, end_time,
    break_time, repeat_days, repeat_end_date
) SELECT 4, 5, '2024-03-01', '09:00:00', '18:00:00', '01:00:00', 'MON,TUE,WED', '2024-12-31'
...
INSERT IGNORE INTO schedule (
    store_id, user_id, work_date, start_time, end_time,
    break_time, repeat_days, repeat_end_date
) SELECT 5, 6, '2024-03-02', '07:00:00', '16:00:00', '01:00:00', 'MON,WED,FRI', '2024-12-31'
